...
using namespace std;
// This file, again, provides only environment and tests, while solution is placed in another file
...
public:
    ...
    [[nodiscard]] size_t GetMemoryUsedByBooks() const {
        return memory_used_by_books_;
    }

    [[nodiscard]] int GetUnpackedBooksCount() const {
