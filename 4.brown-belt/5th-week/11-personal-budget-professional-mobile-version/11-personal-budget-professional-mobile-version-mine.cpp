...
public:
    ...
    [[nodiscard]] MoneyState Collapse(MoneyState origin, IndexSegment segment) const {
...
private:
    ...
    public:
        ...
        [[nodiscard]] Data ProcessEmpty(const NodeHolder&) const {
            return {};
        }

        [[nodiscard]] Data ProcessFull(const NodeHolder& node) const {
            return node->data;
        }

        [[nodiscard]] Data ProcessPartial(const NodeHolder&, IndexSegment, const Data& left_result, const Data& right_result) const {
